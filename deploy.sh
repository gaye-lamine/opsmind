...
AGENT_BUILDER_PROJECT_ID=$(get_env_var "AGENT_BUILDER_PROJECT_ID")
AGENT_BUILDER_LOCATION=$(get_env_var "AGENT_BUILDER_LOCATION")
AGENT_BUILDER_COLLECTION=$(get_env_var "AGENT_BUILDER_COLLECTION")
AGENT_BUILDER_ENGINE_ID=$(get_env_var "AGENT_BUILDER_ENGINE_ID")
AGENT_BUILDER_SERVING_CONFIG=$(get_env_var "AGENT_BUILDER_SERVING_CONFIG")
VECTOR_SEARCH_ENABLED=$(get_env_var "VECTOR_SEARCH_ENABLED")
VECTOR_DIMENSIONS=$(get_env_var "VECTOR_DIMENSIONS")
...
gcloud run deploy "${APP_NAME}-api" \
  ...
  --port=8080 \
  --set-env-vars="USE_VERTEX_AI=true,GOOGLE_CLOUD_PROJECT_ID=${PROJECT_ID},GOOGLE_CLOUD_LOCATION=${LOCATION},NODE_ENV=production,CORS_ORIGINS=*,GITLAB_PROJECT_ID=${GITLAB_PROJECT_ID},AGENT_BUILDER_PROJECT_ID=${AGENT_BUILDER_PROJECT_ID},AGENT_BUILDER_LOCATION=${AGENT_BUILDER_LOCATION},AGENT_BUILDER_COLLECTION=${AGENT_BUILDER_COLLECTION},AGENT_BUILDER_ENGINE_ID=${AGENT_BUILDER_ENGINE_ID},AGENT_BUILDER_SERVING_CONFIG=${AGENT_BUILDER_SERVING_CONFIG},VECTOR_SEARCH_ENABLED=${VECTOR_SEARCH_ENABLED},VECTOR_DIMENSIONS=${VECTOR_DIMENSIONS}" \
